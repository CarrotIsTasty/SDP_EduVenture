    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($answer1 === $dbAnswer1 && $answer2 === $dbAnswer2 && $answer3 === $dbAnswer3) {
                ...
                header("Location: Lecturer New Password.php"); // Corrected file name
                exit();
            } else {
...
<head>
    ...
    <title>Lecturer's Security Questions Password Recovery</title>
</head>
<body>
        ...
        <div class="password-recovery-header">
            ...
            <div class="security-question">
                ...
                <div class="password-recovery-buttons">
                    <a href="Profile Page (Lecturer).html">Cancel</a> <!-- Replace with actual cancel page -->
...
<style>
        ...
        body {
            ...
            background-image: url('img/diamondwp.jpeg');
